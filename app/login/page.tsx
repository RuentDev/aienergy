...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-secondary/20 to-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-border/50 backdrop-blur-sm bg-card/95 animate-fade-in-up relative z-10">
        <CardHeader className="space-y-4 text-center pb-6">
          ...
          <div>
            ...
            <CardDescription className="text-base mt-2">
              Sign in to your AI Energy Shop account
            </CardDescription>
          </div>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-11 bg-accent hover:bg-accent/90 text-white font-medium transition-all hover:scale-[1.02] shadow-lg shadow-accent/20"
            >
              Sign In
            </Button>
